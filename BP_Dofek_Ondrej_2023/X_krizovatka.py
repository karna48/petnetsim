...
def run():
    ...
    RJ = Transition('RJ')
    JV = TransitionStochastic('JV', 0.3)
    JZ = TransitionStochastic('JZ', 0.3)
    JS = TransitionStochastic('JS', 0.4)
    OJZ = TransitionTimed('OJZ', 3)
    OJV = TransitionTimed('OJV', 3)
    OJS = TransitionTimed('OJS', 3)
    OJZ1 = Transition('OJZ1')
    OJV1 = Transition('OJV1')
    OJS1 = Transition('OJS1')

    RV = Transition('RV')
    VZ = TransitionStochastic('VZ', 0.4)
    VJ = TransitionStochastic('VJ', 0.3)
    VS = TransitionStochastic('VS', 0.3)
    ...
    RZ = Transition('RZ')
    ZJ = TransitionStochastic('ZJ', 0.3)
    ZV = TransitionStochastic('ZV', 0.3)
    ZS = TransitionStochastic('ZS', 0.4)
    OZV = TransitionTimed('OZV', 3)
    OZJ = TransitionTimed('OZJ', 3)
    OZS = TransitionTimed('OZS', 3)
    OZV1 = Transition('OZV1')
    OZJ1 = Transition('OZJ1')
    OZS1 = Transition('OZS1')

    RS = Transition('RS')
    SJ = TransitionStochastic('SJ', 0.4)
    SV = TransitionStochastic('SV', 0.3)
    SZ = TransitionStochastic('SZ', 0.3)
    ...
    print('-----------------------------------------------')
    with open('krizovatky/X_krizovatka.json', 'w') as sem:
